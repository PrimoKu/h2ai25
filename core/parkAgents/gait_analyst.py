...
class GaitAgent:
    def __init__(self, model="gpt-4o", temperature=0, api_key=None):
        ...
        # Define the gait expert persona
        self.persona = """You are a specialized neurologist with extensive experience in gait monitoring and analysis.

                            Your responsibilities:
                            1. Carefully analyze gait data to identify patterns, trends, and anomalies
                            2. Detect potential shorter step lengths, asymmetrical walking patterns, and freezing of gait
                            3. Assess the overall gait health based on gait variability and patterns
                            4. Provide evidence-based insights about motor function
